    ...
    <div class="create-group-page container">
        ...
        <!--<div class="ds">-->
            ...
            <div class="create_group_buttons">
                <input class="create_group_input"  type="text" name="text" placeholder="Group Name" required>
                <router-link to="SelectMembers"><button class="create_group_btn" >Create Group</button></router-link>
            </div>
